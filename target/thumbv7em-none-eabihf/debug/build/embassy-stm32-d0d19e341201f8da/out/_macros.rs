...
macro_rules! foreach_flash_region {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_flash_region_inner!((Bank1Region1,32,32768));
        __foreach_flash_region_inner!((Bank1Region2,32,131072));
        __foreach_flash_region_inner!((Bank1Region3,32,262144));
        __foreach_flash_region_inner!((OTPRegion,4,1152));
    };
}#[allow(unused)]
macro_rules! foreach_interrupt {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_interrupt_inner!((CAN3,can,CAN,RX0,CAN3_RX0));
        __foreach_interrupt_inner!((CAN3,can,CAN,RX1,CAN3_RX1));
        __foreach_interrupt_inner!((CAN3,can,CAN,SCE,CAN3_SCE));
        __foreach_interrupt_inner!((CAN3,can,CAN,TX,CAN3_TX));
        ...
        __foreach_interrupt_inner!((ETH,eth,ETH,WKUP,ETH));
        ...
        __foreach_interrupt_inner!((LTDC,ltdc,LTDC,ER,LTDC));
        ...
        __foreach_interrupt_inner!((MDIOS,mdios,MDIOS,WKUP,MDIOS));
        ...
        __foreach_interrupt_inner!((USB_OTG_HS,otg,OTG,EP1_IN,OTG_HS));
        __foreach_interrupt_inner!((USB_OTG_HS,otg,OTG,EP1_IN,OTG_HS_EP1_IN));
        __foreach_interrupt_inner!((USB_OTG_HS,otg,OTG,EP1_OUT,OTG_HS));
        ...
        __foreach_interrupt_inner!((USB_OTG_HS,otg,OTG,WKUP,OTG_HS));
        ...
        __foreach_interrupt_inner!((CAN3_TX));
        __foreach_interrupt_inner!((CAN3_RX0));
        __foreach_interrupt_inner!((CAN3_RX1));
        __foreach_interrupt_inner!((CAN3_SCE));
...
macro_rules! foreach_peripheral {
    ($($pat:tt => $code:tt;)*) => {
        ...
        __foreach_peripheral_inner!((can,CAN3));
